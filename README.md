...
不想折腾开发环境？直接下载打包好的 `.exe`，解压双击就能运行，无需安装任何依赖。

👉 **[最新版下载](https://github.com/vinchemerson-cmyk/inventory-manager/releases/latest)** （进入后下载 `元器件库存管理-v1.0.0.zip`，解压运行 `元器件库存管理.exe`）
